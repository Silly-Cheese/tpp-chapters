...
required_portal = [
    ...
    'navLink("/chapter/workflows"',
    'navLink("/chapter/submissions"',
    'navLink("/chapter/communications"',
    'navLink("/chapter/support"',
...
if 'content="20260803.10"' not in index:
    errors.append("Production build is not 20260803.10")
for asset in (
    "assets/chapter-portal-v2.css?v=20260803.10",
    "assets/js/portal-permission-guard.js?v=20260803.10",
    "assets/js/chapter-portal-v2.js?v=20260803.10",
):
