...
if not build or build.group(1) != "20260803.9":
    errors.append("Production build must be 20260803.9")
for asset in (
    "assets/chapter-portal-mobile-members.css?v=20260803.9",
    "assets/js/chapter-portal-mobile-members.js?v=20260803.9",
):
